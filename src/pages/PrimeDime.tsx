...
const PrimeDime = () => {
  ...
  const handleExport = () => {
    ...
    // Create a text format export
    let exportText = "MY PRIME DIME - TOP 10 COLLEGE MATCHES\n";
    exportText += "=" .repeat(50) + "\n\n";
    exportText += `PROFILE SUMMARY:\n${recommendations.summary}\n\n`;
    exportText += "=" .repeat(50) + "\n\n";
    
    recommendations.colleges?.forEach((college: any, index: number) => {
      exportText += `${index + 1}. ${college.name}\n`;
      exportText += `   Division: ${college.division}\n`;
      exportText += `   Location: ${college.location}\n`;
      exportText += `   Why This Match: ${college.fit_reason}\n\n`;
      exportText += `   RECRUITER CONTACT:\n`;
      if (college.recruiter_name) exportText += `   Name: ${college.recruiter_name}\n`;
      if (college.recruiter_email) exportText += `   Email: ${college.recruiter_email}\n`;
      if (college.recruiter_phone) exportText += `   Phone: ${college.recruiter_phone}\n`;
      if (college.recruiter_twitter) exportText += `   Twitter: ${college.recruiter_twitter}\n`;
      exportText += "\n" + "-".repeat(50) + "\n\n";
    });

    exportText += `NEXT STEPS:\n${recommendations.next_steps}\n\n`;
    exportText += "Generated by ForSWAGs Prime Dime\n";
    ...
    a.href = url;
    a.download = `prime-dime-recommendations-${new Date().toISOString().split('T')[0]}.txt`;
    ...
    toast({
      ...
      description: "Your Prime Dime recommendations have been downloaded",
    });
  };
