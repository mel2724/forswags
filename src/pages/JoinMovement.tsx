        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
              ...
              {/* Sports Showcase */}
              <div className="relative rounded-xl overflow-hidden border-2 border-primary/20 hover:border-primary/40 transition-all duration-300 group bg-gradient-to-br from-primary/10 to-primary/5 p-12">
