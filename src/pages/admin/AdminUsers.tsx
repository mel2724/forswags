...
export default function AdminUsers() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      console.log("AdminUsers - Current session:", session?.user?.id, session?.user?.email);
      ...
      console.log("AdminUsers - User role check:", roleCheck, roleError);
      ...
      console.log("AdminUsers - Profiles data:", profilesData?.length, "Error:", profilesError);
