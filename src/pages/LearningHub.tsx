...
const LearningHub = () => {
  ...
  return (
    <div className="min-h-screen bg-background sports-pattern">
      <SEO 
        title="Learning Hub - ForSWAGs Training Platform"
        description="Access life skills videos, educational courses, and training content. Master the game on and off the field with comprehensive learning resources."
        keywords="athlete training, life skills, educational courses, video learning, student athlete development"
      />
      <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-2 cursor-pointer" onClick={() => navigate("/")}>
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-muted-foreground uppercase text-sm tracking-wider mb-8">
            Life skills videos • Educational courses • Earn badges • Track progress
          </p>
